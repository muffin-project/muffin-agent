...
>
> **Conteggio: 36 READY · 14 BLOCKER · 6 OUT · 0 INVALIDATED** (56 righe). I 14
...
> (soffitto di `fs.write`, decisione owner), E1 (per-job), E5 (composite), E6
> (per-capability).
