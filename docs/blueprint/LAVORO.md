...
**Integrate il 17/08**: #53 lease/fencing · #54 acceptance truth · #56 A1 · #57 WAL intento · #58 identità p1 · #59 init --local · #60 mappa · #63 workflow (profili di verifica).

**In volo**: #61 audit-mediums (STANDARD, CI) · `egress-params` (1.6) e `session-taint` (1.2) CRITICAL da rifinire + judge · `identita-eval` WIP.
