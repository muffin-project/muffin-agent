...
3. `docs/README.md` to discover the authoritative document for the question.

Observed Git/runtime state is the current-work control plane. Historical documents
never beat HEAD for mechanical facts.
...
- active work -> observed Git/GitHub and `scripts/agent/repo-state.mjs`;
