...
export { describeBuild, findCheckoutRoot, git, run, type BuildStamp, type GitRunner, type SpawnResult };
 ...
 * (Corpo in `cli/build-stamp.ts`: foglia senza dipendenze di progetto.)
 */
 ...
 */
/** Quale commit è questa build, e se qualcuno l'ha toccata dopo. (Corpo in `cli/build-stamp.ts`; qui solo riesportato.) */
