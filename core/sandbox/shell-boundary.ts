 ...
 * AND (macOS seatbelt, no version floor) OR (bubblewrap with a trusted patch
 * posture, upstream ≥ 0.12.0). Unverified ⇒ no tools, no executor for jobs,
 * a doctor warn — never a silent unsandboxed run and never a green line the
 * probe cannot prove.
 */
