 ...
 * restating itself.
 *
 * `goal → plan → todo{done|blocked|waiting|retry|pending} → resume` (M5-BIS.md#wait-e-todo-sono-primitive-del-runtime-non-tool).
...
describe('muovere un passo', () => {
  ...
  it('il criterio di completamento è deterministico: si legge dalle righe', () => {
    // M5-BIS.md#wait-e-todo-sono-primitive-del-runtime-non-tool asks for a deterministic completion criterion. This is it, and
