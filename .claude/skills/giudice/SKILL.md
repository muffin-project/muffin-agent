---
description: Review indipendente di una claim CRITICAL secondo docs/JUDGE.md. Solo su invocazione esplicita, in una sessione fresca che non ha scritto il codice.
disable-model-invocation: true
---

# Giudice

Il protocollo è in `docs/JUDGE.md`. Leggilo ed eseguilo; non è ricopiato qui.
...
3. **il protocollo di `docs/JUDGE.md`**, incluse le cinque domande obbligatorie
